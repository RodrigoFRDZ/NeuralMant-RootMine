...
def mostrar_identificacion() -> None:
    ...
    with derecha:
        ...
        st.markdown(f'<div class="login-master">👥 &nbsp;Maestro v4.4.0 · {resumen["total"]} usuarios habilitados</div>', unsafe_allow_html=True)
        st.markdown('<div class="creator-seal">RootMine v4.4.0 Cloud · Creado por <b>Rodrigo Fernández</b></div>', unsafe_allow_html=True)
...
def mostrar_menu() -> str:
    ...
    with st.sidebar:
        ...
        st.markdown('<div class="sidebar-credit">NeuralMant Suite · RootMine v4.4.0 Cloud<br>© 2026 Rodrigo Fernández</div>', unsafe_allow_html=True)
        return pagina
